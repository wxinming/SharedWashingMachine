...
local sProductKey,sProductSecret,sGetDeviceNameFnc,sGetDeviceSecretFnc,sSetDeviceSecretFnc,mqttClient
...
function clientDataTask(host,tPorts,clientId,user,password)
    while true do
        ...
        mqttClient = mqtt.client(clientId,sKeepAlive or 240,user,password,sCleanSession,sWill)
        local portIdx = 0
        while true do
